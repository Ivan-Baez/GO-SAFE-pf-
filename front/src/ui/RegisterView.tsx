...
function RegisterView() {
    ...
    const ciudadPorPais: Record<string, string []> ={
      ...
      Argentina: ["Buenos Aire","Córdoba","Rosario"]
    }
    ...
    >
      {({errors,isSubmitting, values}) => (
        <Form style ={{width :"100%", maxWidth :"600px"}}>
          <div>
                  <Field
                    ...
                    placeholder="Nombre completo"
                                      />
                  <ErrorMessage name="name">{(msg) => <span style={{ color: "#e53e3e", fontSize: "11px", marginTop: "3px"}}>{msg}</span>}</ErrorMessage>
                </div>
          <div>
          ...
          <div>
            <label>Género</label>
            <Field name="genre" type="selection" />
          ...
          <button
            ...
            >
              ...
              <div>
                ...
                <Link href="/login" style={{ color: "#f5c518", fontWeight: "700", textDecoration: "none" }}>
                  Inicia sesión
                </Link>
              </p>
              </div>
