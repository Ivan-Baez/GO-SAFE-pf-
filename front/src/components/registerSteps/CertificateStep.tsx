        ...
        <Form className="w-full space-y-6 z-10">
          ...
          <div className={`space-y-4 transition-opacity ${values.noCertificado ? 'opacity-30 pointer-events-none' : 'opacity-100'}`}>
            ...
            <div>
              ...
              />
              <p className="text-[11px] text-gray-500 italic mt-1">Escribelo tal como aparece en tu certificado</p>
            </div>
            ...
            <div className="border-2 border-dashed border-gray-200 rounded-2xl p-8 flex flex-col items-center space-y-4 mt-10">
              ...
              <button 
                type="submit" 
                className="w-full bg-[#f0ba3c] hover:bg-[#e0ab2c] text-white font-bold py-3 rounded-2xl shadow-md transition-all uppercase text-sm"
              >
               Subir certificado
              </button>

              {/* Texto legal inferior */}
              <div className="text-[11px] text-gray-600 space-y-2 px-2">
                <p>Sólo se aceptarán documentos auténtitos.</p>
                <p>Cualquier información falsa puede resultar en la desaprobación o suspención de tu cuenta.</p>
